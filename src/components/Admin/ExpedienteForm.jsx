    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4 rounded-xl border border-border bg-white p-6 shadow-[var(--shadow-elevation-sm)]">
          ...
          <button
            type="submit"
            className="mt-2 cursor-pointer rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground transition-opacity duration-200 hover:opacity-90"
          >
            Guardar expediente
          </button>
        </form>
